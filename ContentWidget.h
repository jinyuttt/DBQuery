...
private:
    ...
    MainLog *right_log_widget;//右边日志
    QTabWidget  *tabMain;//tab
    QStackedWidget *statked_widget;//statked_widget根据需要替换tabMain
    bool isTab=true;
    QMap<int,QObject*> mapObj;
    QHash<QString,QObject*> hashObj;
    QMap<QString,QString> mapReg;
};
