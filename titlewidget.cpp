	...
	: QWidget(parent)
{
	...
	//ÉèÖÃÍ¼Æ¬
    medal_button->setPicName(QString(":/src/imgs/img/sysButton/medal"));
    skin_button->setPicName(QString(":/src/imgs/img/sysButton/skin"));
    min_button->setPicName(QString(":/src/imgs/img/sysButton/min"));
    close_button->setPicName(QString(":/src/imgs/img/sysButton/close"));
    main_menu_button->setPicName(QString(":/src/imgs/img/sysButton/menu"));
    feedback_button->setPicName(QString(":/src/imgs/img/sysButton/feedback"));
   ...
   // string_list<<":/src/imgs/img/toolWidget/tiJian"<<":/src/imgs/img/toolWidget/muMa"<<":/src/imgs/img/toolWidget/repair"<<":/src/imgs/img/toolWidget/qingLi"
    //    <<":/src/imgs/img/toolWidget/jiaSu"<<":/src/imgs/img/toolWidget/expert"<<":/src/imgs/img/toolWidget/menZhen"<<":/src/imgs/img/toolWidget/gongNeng";
    string_list<<":/src/imgs/img/toolWidget/tiJian"<<":/src/imgs/img/toolWidget/muMa";
...
//	}
    ...
    QPixmap pixmap(":/src/imgs/img/safe");
...
void TitleWidget::addToolButton(QString name, QString ico, int i)
{
    ToolButton *tool_button = new ToolButton(ico);
    tool_button->resize(40,30);
    button_list.append(tool_button);
    connect(tool_button, SIGNAL(clicked()), signal_mapper, SLOT(map()));
    signal_mapper->setMapping(tool_button, QString::number(i, 10));
    button_layout->addWidget(tool_button, 0, Qt::AlignBottom);
