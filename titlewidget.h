...
public:
    ...
    void addToolButton(QString name, QString ico, int i);
    void addSoftlable();
signals:
	void showSkin();
    void showMin();
...
private:
    ...
    QLabel *logo_label;//最右
    QList<ToolButton *> button_list;//按钮列表
    QHBoxLayout *button_layout;//按钮列表layout
    QSignalMapper *signal_mapper;
    QVBoxLayout *safe_layout;//最右边标签
};
